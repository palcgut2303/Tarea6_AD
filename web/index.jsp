    ...
    <body class="bg-gray-100 h-screen flex justify-center items-center">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
            ...
            <div class="flex items-center mb-4">
                <img src="images/login.jpg" alt="Imagen" class="mr-4 h-70 w-50"> 
                <form action="./Usuario?accion=login" method="POST" class="space-y-4">
                    ...
                    <a href="./Usuario?accion=register" method="POST" class="inline-block bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded transition duration-300 ease-in-out">¿Aún no tienes cuenta? Regístrate aquí</a>
                </form>
            </div>
